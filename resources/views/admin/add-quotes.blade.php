...
{{--                        <li class="breadcrumb-item active">jsGrid</li>--}}
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form id="quote-add-form" action="{{url((isset($quote)?'edit-quotes':'add-quotes'))}}" method="post">
                    @csrf
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="" placeholder="Enter Email" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" class="form-control" rows="3" placeholder="Address with phone number" required></textarea>
                        </div>
                    </div>
                </div>
{{--                    <div class="row">--}}
                        ...
                        <table class="table table-hover text-nowrap table-bordered">
                            ...
                            @foreach($services as $service)
                               <tr>
                                    <td>
                                        <div class="">
                                            <input type="checkbox" name="service[]" id="chk_{{$service->id}}" value="{{$service->id}}">
                            ...
                            <tr>
                                ...
                                <th>&nbsp;</th>
                                <th>Total Price</th>
                                <th><input type="text" name="quote_price" id="quote_price" class="form-control col-md-5 ml-2" value=""></th>
                            </tr>
{{--                            <tr>--}}
{{--                                <th>&nbsp;</th>--}}
{{--                                <th>&nbsp;</th>--}}
{{--                                <th>&nbsp;</th>--}}
{{--                                <th>Tax</th>--}}
{{--                                <th><input type="text" name="tax" id="tax" class="form-control col-md-5 ml-2" value=""></th>--}}
{{--                            </tr>--}}
                            <tr>
                                <th>&nbsp;</th>
                                <th>&nbsp;</th>
                               ...
                               <th>Adjustment if any</th>
                                <th><input type="text" name="adjustment_price" id="adjustment_price" class="form-control col-md-5 ml-2" value=""></th>
                            </tr>
                            <tr>
                                <th>&nbsp;</th>
                                <th>&nbsp;</th>
                                ...
                                <th><input type="text" name="final_quote_price" id="final_quote_price" class="form-control col-md-5 ml-2" value=""></th>
                            </tr>
